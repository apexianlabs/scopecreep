...
export default function DashboardPage() {
  ...
  const handleLogout = () => {
    document.cookie = 'sco_token=; path=/; max-age=0'
    document.cookie = 'sco_user=; path=/; max-age=0'
    router.push('/login')
  }
    ...
    <div style={{width:220,background:'#0f172a',display:'flex',flexDirection:'column',minHeight:'100vh',flexShrink:0,position:'relative'}}>
      ...
      <div style={{padding:'20px 16px 16px',borderBottom:'1px solid rgba(255,255,255,0.06)'}}>
        <Link href="/" style={{display:'flex',alignItems:'center',gap:9,textDecoration:'none'}}>
          ...
          <div>
            <p style={{fontSize:13,fontWeight:800,color:'#fff',lineHeight:1,letterSpacing:'-0.3px'}}>ScopeCreep</p>
            <p style={{fontSize:10,color:'#475569',lineHeight:1,marginTop:2}}>Spot scope creep before</p>
          </div>
        </Link>
      </div>
      ...
      <div style={{padding:'4px 8px',flex:1}}>
        {[
          ...
          { icon:'□', label:'Analyses', href:'/items' },
      ...
      <div style={{flex:1,display:'flex',flexDirection:'column',minWidth:0,overflow:'hidden'}}>
        ...
        <div style={{background:'#fff',borderBottom:'1px solid #f1f5f9',height:56,display:'flex',alignItems:'center',padding:'0 20px',gap:12,flexShrink:0}}>
          ...
          <div style={{flex:1}}>
            ...
            <p style={{fontSize:11,color:'#94a3b8',marginTop:1}}>Here's your ScopeCreep overview.</p>
          </div>
          <Link href="/generate"
          ...
          <div style={{display:'grid',gridTemplateColumns: isMobile ? '1fr' : '1fr 300px',gap:16}}>
            ...
            <div style={{background:'#fff',borderRadius:14,border:'1px solid #f1f5f9',overflow:'hidden',boxShadow:'0 1px 3px rgba(0,0,0,0.04)'}}>
              <div style={{padding:'16px 20px',borderBottom:'1px solid #f8fafc',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
                <p style={{fontSize:14,fontWeight:700,color:'#0f172a',letterSpacing:'-0.2px'}}>Recent Analyses</p>
              ...
              {loading ? (
                ...
                <div style={{padding:'48px 24px',textAlign:'center'}}>
                  ...
                  <p style={{fontSize:14,fontWeight:600,color:'#0f172a',marginBottom:6}}>No Analyses yet</p>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              ...
              <div style={{background:'linear-gradient(135deg,#7c3aed 0%,#7c3aedcc 100%)',borderRadius:14,padding:20,color:'#fff'}}>
                ...
                <p style={{fontSize:12,color:'rgba(255,255,255,0.75)',marginBottom:14,lineHeight:1.5}}>Spot scope creep before it kills your project</p>
              ...
              {items.length >= 2 && (
                <div style={{background:'#fafafa',borderRadius:14,border:'1px solid #f1f5f9',padding:20}}>
                  ...
                  <p style={{fontSize:12,color:'#64748b',marginBottom:12,lineHeight:1.5}}>Get unlimited Analyses from $19/month.</p>
