    ...
    <div style={{width:220,background:'#0f172a',display:'flex',flexDirection:'column',minHeight:'100vh',flexShrink:0}}>
      <div style={{padding:'20px 16px',borderBottom:'1px solid rgba(255,255,255,0.08)'}}>
        <Link href="/" style={{display:'flex',alignItems:'center',gap:8,textDecoration:'none'}}>
          ...
          <div>
            <p style={{fontSize:13,fontWeight:800,color:'#fff',lineHeight:1}}>ScopeCreep</p>
            <p style={{fontSize:10,color:'#64748b',lineHeight:1,marginTop:2}}>Spot scope creep before</p>
          </div>
        </Link>
      </div>
      ...
      <div style={{flex:1,display:'flex',flexDirection:'column',minWidth:0}}>
        <div style={{background:'#fff',borderBottom:'1px solid #e2e8f0',minHeight:56,display:'flex',alignItems:'center',padding:'8px 20px',gap:12,flexShrink:0}}>
          ...
          <div style={{flex:1}}>
            ...
            <p style={{fontSize:12,color:'#94a3b8',marginTop:2}}>Here's your ScopeCreep activity.</p>
          </div>
